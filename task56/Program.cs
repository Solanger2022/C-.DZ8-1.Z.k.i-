...
int[,] array = new int[massVol, massVol + 1];
...
void FillArrayRandomNumbers(int[,] soughtArray)
{
    for (int i = 0; i < soughtArray.GetLength(0); i++)
    {
        for (int j = 0; j < soughtArray.GetLength(1); j++)
        {
...
void PrintArray(int[,] soughtArray)
{
    for (int i = 0; i < soughtArray.GetLength(0); i++)
    {
